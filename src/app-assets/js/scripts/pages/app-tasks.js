...
var badgeColors = {
  "Feed": "badge-light-primary",
  "Health": "badge-light-success",
  "Reproduction": "badge-light-danger",
  "Breeding": "badge-light-warning",
  "Other": "badge-light-info",
}
...
$(function () {
  ...
  function formatData (data) {
    ...
    var $result= $(
      '<span class="d-flex align-items-center"><img class="avatar" style="height: 21px; width: 21px;" src="app-assets/images/slider/cow.jpg"/> ' + data.text + '</span>'
    );
    return $result;
  };
